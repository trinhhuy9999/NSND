...
<body style="background-color: #04132b;">
    <header style="display: flex; justify-content: space-between; color: white; align-items: center;padding: 0 20px;">
        <div>
            <img width="200" height="100"
                ...
                class="header-logo-dark" alt="Dá»ch Vá»¥ Gia SÆ°">
        </div>
        <div style="display: flex; align-items: center;margin-right: 10px;">
            <img width="30px" height="30px"
                src="https://dichvugiasu.shostweb.com/wp-content/uploads/2021/09/placeholder.svg"
    ...
    <hr />
    <nav style="display: flex; align-items: center; color: white;justify-content: space-between; padding: 10px;">
        <div style="display: flex;">
    ...
    <main style="background-color: white; ">
        <div style="padding-bottom: 60px; padding-top: 30px; padding-left: 20px; padding-right: 20px;max-width: 800px;margin-left: auto;margin-right: auto;">
            <h1 >Thông tin liên hệ </h1>
            <p>Trung tâm gia sư chất lượng cao.</p>

            <div style="display: flex;justify-content: space-between;">
                <div style="padding: 10px;flex: 1;">
                    <img width="100" height="100" src="https://dichvugiasu.shostweb.com/wp-content/uploads/2021/09/placeholder.svg" class="attachment-large size-large" alt="" loading="lazy" srcset="https://dichvugiasu.shostweb.com/wp-content/uploads//2021/09/placeholder.svg 150w, https://dichvugiasu.shostweb.com/wp-content/uploads//2021/09/placeholder.svg 300w, https://dichvugiasu.shostweb.com/wp-content/uploads//2021/09/placeholder.svg 1024w" sizes="(max-width: 1020px) 100vw, 1020px">
                    <h3 style="margin-top: 20px;"> Địa Chỉ</h3>
                    <p>9999 Hồ Tùng Mậu, Bắc Từ Liêm,Hà Nội, Việt Nam</p>
                </div>
                <div style="padding: 10px;flex: 1;">
                    <img width="100" height="100" src="https://dichvugiasu.shostweb.com/wp-content/uploads/2021/09/clock.svg" class="attachment-large size-large" alt="" loading="lazy" srcset="https://dichvugiasu.shostweb.com/wp-content/uploads//2021/09/clock.svg 150w, https://dichvugiasu.shostweb.com/wp-content/uploads//2021/09/clock.svg 300w, https://dichvugiasu.shostweb.com/wp-content/uploads//2021/09/clock.svg 1024w" sizes="(max-width: 1020px) 100vw, 1020px">
                    <h3 style="margin-top: 20px;">Giờ làm việc</h3>
                    <p>Thứ 2 – Thứ 7: 8:00 – 17:00<br>Chủ nhật: Đóng cửa</p>
                </div>
            </div>
            ...
            <div style="display: flex;;justify-content: space-between; margin-top: 50px;">
                <div style="padding: 10px;flex: 1;">
                    <img width="100" height="100" src="https://dichvugiasu.shostweb.com/wp-content/uploads/2021/09/email.svg" class="attachment-large size-large" alt="" loading="lazy" srcset="https://dichvugiasu.shostweb.com/wp-content/uploads//2021/09/email.svg 150w, https://dichvugiasu.shostweb.com/wp-content/uploads//2021/09/email.svg 300w, https://dichvugiasu.shostweb.com/wp-content/uploads//2021/09/email.svg 1024w" sizes="(max-width: 1020px) 100vw, 1020px">
                    <h3 style="margin-top: 20px;">Email</h3>
                    <p>htbtutor@gmail.com</p>
                </div>
                <div style="padding: 10px;flex: 1;">
                    <img width="100" height="100" src="https://dichvugiasu.shostweb.com/wp-content/uploads/2021/09/phone-call.svg" class="attachment-large size-large" alt="" loading="lazy" srcset="https://dichvugiasu.shostweb.com/wp-content/uploads//2021/09/phone-call.svg 150w, https://dichvugiasu.shostweb.com/wp-content/uploads//2021/09/phone-call.svg 300w, https://dichvugiasu.shostweb.com/wp-content/uploads//2021/09/phone-call.svg 1024w" sizes="(max-width: 1020px) 100vw, 1020px">
