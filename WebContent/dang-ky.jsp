...
<body style="background-color: #04132b;">
    ...
    <main style="background-color: white; ">
        <div style="padding-bottom: 60px; padding-top: 30px; padding-left: 20px; padding-right: 20px;max-width: 800px;margin-left: auto;margin-right: auto;">
            ...
            <form action="action_page.php" method="post" style="border-radius:6px;border: 1px solid #ccc;padding: 10px;">
                <h1 style="color: rgb(70, 175, 66);text-align: center;">Sign Up </h1>
                ...
                <div class="clearfix" style="display: flex;justify-content: center;" >
                    <button type="submit" style="background-color: #1877f2;width: 100%; margin-top: 10px; max-width: 200px; height: 40px;color: white;margin: auto;">Sign Up</button>
                </div>
            </form>
        </div>
    </main>
